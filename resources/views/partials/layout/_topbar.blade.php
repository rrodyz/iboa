...
--}}
        ...
        <div class="h-14 flex items-center gap-3 px-4 lg:px-6">
            ...
            {{-- ── Recherche globale (fallback mobile only maintenant) ──────── --}}
            <div class="hidden"
                 x-data="{
                ...
                <div class="relative" x-data="{ open: false, unread: 0, items: [] }"
                    ...
                    <div x-show="open"
                        ...
                        <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                            ...
                            <a href="{{ route('notifications.index') }}" class="text-xs text-indigo-600 hover:text-indigo-800 font-medium">Tout voir</a>
                        </div>
