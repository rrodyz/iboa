...
<div class="space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Liste des devis</h1>
    ...
    <form method="GET" class="bg-white rounded-xl border border-gray-200 p-4">
        ...
        <div class="mt-3 flex gap-2">
            ...
            <a href="{{ route('reports.liste-devis') }}" class="border border-gray-300 text-gray-600 hover:bg-gray-50 text-sm px-3 py-2 rounded-lg">Réinitialiser</a>
        </div>
    </form>
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <table class="w-full text-sm">
            <thead class="bg-indigo-600 text-white">
                <tr>
                    <th class="px-4 py-3 text-left font-semibold">N° Devis</th>
                    <th class="px-4 py-3 text-center font-semibold">Date</th>
                    <th class="px-4 py-3 text-center font-semibold">Validité</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2.5 text-center text-gray-600">{{ $r->expires_at?->format('d/m/Y') ?? '—' }}</td>
            ...
            <tfoot class="bg-indigo-900 text-white font-bold">
                <tr>
                    <td class="px-4 py-3" colspan="5">TOTAL ({{ $totals['count'] }} devis)</td>
