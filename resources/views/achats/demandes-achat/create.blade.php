...
<div class="max-w-4xl mx-auto space-y-6"
    ...
    <form action="{{ route('achats.demandes-achat.store') }}" method="POST">
        @csrf
        <div class="space-y-5">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="needed_at" value="{{ old('needed_at') }}"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                    </div>

                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Justification / Objet</label>
                        <input type="text" name="justification" value="{{ old('justification') }}"
...
function purchaseRequestForm() {
    return {
        ...
        onProductChange(event, index) {
            ...
            // Auto-fill description only if the user hasn't typed anything yet
