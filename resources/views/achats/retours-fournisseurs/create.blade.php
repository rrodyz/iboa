...
<div class="max-w-5xl mx-auto space-y-6"
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Nouveau retour fournisseur</h1>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="returned_at" value="{{ old('returned_at', date('Y-m-d')) }}"
...
function supplierReturnForm() {
    return {
        ...
        get totalTtc() {
            return this.subtotalHt; // No tax for simplicity (can be extended)
        },
