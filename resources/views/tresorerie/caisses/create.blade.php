...
<div class="max-w-2xl space-y-5">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('tresorerie.caisses.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Retour</a>
    </div>
    ...
    <form method="POST" action="{{ route('tresorerie.caisses.store') }}" class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        @csrf
