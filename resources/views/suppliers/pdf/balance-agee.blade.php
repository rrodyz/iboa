...
.subheader { background:#B45309; color:#e5e7eb; padding:4px 12px; font-size:8pt; font-style:italic; display:table; width:100%; margin-bottom:10px; }
...
.kpi-cell { display:table-cell; width:16%; padding-right:4px; }
...
.kpi-total   { border-color:#F97316; background:#FEF3C7; }
.kpi-total .kpi-value { color:#7C2D12; }
.kpi-non-echu { border-color:#F59E0B; background:#FEF9C3; }
.kpi-non-echu .kpi-value { color:#92400E; }
...
<div class="header">
    <div class="header-top">
        ...
        <div class="header-center">BALANCE ÂGÉE FOURNISSEURS</div>
        <div class="header-right">Au {{ $today->format('d/m/Y') }}</div>
    </div>
</div>
<div class="subheader">
    <div class="subheader-left">Dettes en cours ventilées par ancienneté</div>
    <div class="subheader-right">Édition du {{ now()->format('d/m/Y') }}</div>
</div>

<div class="kpi-row">
    <div class="kpi-cell"><div class="kpi-box kpi-total"><div class="kpi-label">Total dû</div><div class="kpi-value">{{ number_format($totals['total'],0,',',' ') }}</div></div></div>
    <div class="kpi-cell"><div class="kpi-box kpi-non-echu"><div class="kpi-label">Non échu</div><div class="kpi-value">{{ number_format($totals['non_echu'],0,',',' ') }}</div></div></div>
    <div class="kpi-cell"><div class="kpi-box kpi-j1-30"><div class="kpi-label">1 – 30 j</div><div class="kpi-value">{{ number_format($totals['j1_30'],0,',',' ') }}</div></div></div>
    <div class="kpi-cell"><div class="kpi-box kpi-j31-60"><div class="kpi-label">31 – 60 j</div><div class="kpi-value">{{ number_format($totals['j31_60'],0,',',' ') }}</div></div></div>
    <div class="kpi-cell"><div class="kpi-box kpi-j61-90"><div class="kpi-label">61 – 90 j</div><div class="kpi-value">{{ number_format($totals['j61_90'],0,',',' ') }}</div></div></div>
    <div class="kpi-cell"><div class="kpi-box kpi-j90p"><div class="kpi-label">+ 90 j</div><div class="kpi-value">{{ number_format($totals['j90p'],0,',',' ') }}</div></div></div>
</div>
...
<table>
    <thead>
        <tr>
            ...
            <th class="left"  style="width:28%">Fournisseur</th>
            <th class="right" style="width:14%">Total dû (FCFA)</th>
            <th class="right bg-amber"   style="width:12%">Non échu</th>
