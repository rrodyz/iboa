...
<div class="max-w-2xl mx-auto space-y-5">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Modifier les informations de l'entrepôt</p>
        </div>
    </div>

    {{-- Form --}}
    <form action="{{ route('stocks.warehouses.update', $warehouse) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
            ...
            <div class="px-6 py-4 bg-gray-50 rounded-b-xl flex items-center justify-between gap-3">
                <a href="{{ route('stocks.warehouses.show', $warehouse) }}"
