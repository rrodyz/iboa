...
<div class="max-w-2xl">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Nouvelle marque</h1>
    ...
    <form method="POST" action="{{ route('brands.store') }}" class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        @csrf
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="3"
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent resize-none"
