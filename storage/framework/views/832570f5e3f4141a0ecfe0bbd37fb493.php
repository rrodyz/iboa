...
<div x-data="commandPalette()"
     x-show="open"
     x-cloak
     data-search-url="<?php echo e(route('search')); ?>"
...
<?php echo e(json_encode(array_values(array_filter([
...
<?php /**PATH C:\laragon\www\iboa\resources\views/partials/layout/_command-palette.blade.php ENDPATH**/ ?>