                ...
                <div class="flex items-center">
                    ...
                    <?php endif; ?>
                        ...
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <?php if($isPast && ($data['done'] ?? false)): ?>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                </svg>
                            <?php else: ?>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="<?php echo e($step['icon']); ?>"/>
                                </svg>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-1.5 text-center">
                            ...
                            <?php if($data && isset($data['label'])): ?>
                                <p class="text-xs text-gray-400 font-mono leading-tight"><?php echo e($data['label']); ?></p>
                            <?php endif; ?>
                        </div>
...
<?php /**PATH C:\laragon\www\iboa\resources\views/partials/_workflow-ventes.blade.php ENDPATH**/ ?>