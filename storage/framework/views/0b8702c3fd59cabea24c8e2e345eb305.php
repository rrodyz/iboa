...
window._quoteFormData = {
    quote:             <?php echo json_encode($quote ? $quote->load('items') : null, 15, 512) ?>,
    ...
    oldGlobalDiscount: <?php echo json_encode(old('global_discount_amount', 0), 512) ?>,
    oldGlobalPct:      <?php echo json_encode(old('global_discount_percent', 0), 512) ?>,
    selectedClientId:  <?php echo json_encode(old('client_id', $quote?->client_id ?? $selectedClient), 512) ?>,
    clientExemptions:  <?php echo json_encode($clientExemptions, 15, 512) ?>,
};
</script>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="lg:col-span-2">
            ...
            <select name="client_id" x-model="client_id" @change="onClientChange()" required
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php echo e($errors->has('client_id') ? 'border-red-400 bg-red-50' : ''); ?>">
                <option value="">Sélectionner un client...</option>
                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($client->id); ?>"
                        <?php echo e(old('client_id', $quote?->client_id ?? $selectedClient) == $client->id ? 'selected' : ''); ?>>
                        <?php echo e($client->trade_name ?? $client->name); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="date" name="issued_at" required
                   value="<?php echo e(old('issued_at', $quote?->issued_at?->format('Y-m-d') ?? now()->format('Y-m-d'))); ?>"
                   class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php echo e($errors->has('issued_at') ? 'border-red-400 bg-red-50' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="date" name="expires_at" x-model="expires_at"
                   value="<?php echo e(old('expires_at', $quote?->expires_at?->format('Y-m-d'))); ?>"
                   class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php echo e($errors->has('expires_at') ? 'border-red-400 bg-red-50' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="reference" maxlength="50"
                   value="<?php echo e(old('reference', $quote?->reference)); ?>"
        ...
        <div class="lg:col-span-3">
            ...
            <textarea name="notes" rows="2"
                      ...
                      class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('notes', $quote?->notes)); ?></textarea>
        </div>
            ...
            <tbody class="divide-y divide-gray-100">
                <template x-for="(item, index) in items" :key="item._key">
                    <tr class="hover:bg-gray-50 group">
                        ...
                        <?php echo $__env->make('ventes.partials._product_combobox', ['accentColor' => 'blue', 'formName' => 'quote'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="bg-white rounded-xl border border-gray-200 mt-4" x-data="{ open: <?php echo e(($quote?->terms || $quote?->footer_note || old('terms') || old('footer_note')) ? 'true' : 'false'); ?> }">
    ...
    <div x-show="open" x-collapse class="px-5 pb-5 grid grid-cols-1 lg:grid-cols-2 gap-4 border-t border-gray-100 pt-4">
        <div>
            ...
            <textarea name="terms" rows="4"
                      ...
                      class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('terms', $quote?->terms)); ?></textarea>
        </div>
        <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">
            ...
            <textarea name="footer_note" rows="4"
                      ...
                      class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('footer_note', $quote?->footer_note)); ?></textarea>
        </div>
    </div>
</div>
...
<div class="mt-4 flex items-center justify-end gap-3">
    ...
    <button type="submit"
        ...
        <span x-text="submitting ? 'Enregistrement...' : '<?php echo e($quote ? 'Mettre à jour' : 'Enregistrer le devis'); ?>'"></span>
    </button>
</div>
...
function quoteForm() {
    ...
    return {
        ...
        expires_at:              '<?php echo e(old('expires_at', $quote?->expires_at?->format('Y-m-d') ?? '')); ?>',
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\iboa\resources\views/ventes/devis/_form.blade.php ENDPATH**/ ?>