...
<head>
    <?php echo $__env->make('partials.layout._head', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</head>
<body class="font-sans antialiased text-gray-900"
      style="min-height:100vh;">

<?php echo $__env->make('partials.layout._toast-notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="min-h-screen flex" x-data="{}">
    ...
    <?php echo $__env->make('partials.layout._sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    
    <div class="flex-1 flex flex-col min-w-0">

        
        <?php echo $__env->make('partials.layout._topbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="flex items-start gap-3 p-4">
                ...
                <div class="flex-1 min-w-0">
                    <p class="font-semibold text-red-800 mb-1.5">
                        <?php echo e($errors->count() === 1 ? '1 erreur à corriger' : $errors->count() . ' erreurs à corriger'); ?>
        ...
        <main class="erp-content flex-1 overflow-y-auto flex flex-col">
            ...
            <footer class="flex-shrink-0 border-t border-gray-100 bg-white px-4 lg:px-6 py-3">
                <div class="flex flex-wrap items-center justify-between gap-2 text-xs text-gray-400">
                    <span>© <?php echo e(date('Y')); ?> <strong class="text-gray-500">A3 ERP</strong> · Tous droits réservés</span>
...
<?php echo $__env->make('partials.layout._command-palette', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>


<?php echo $__env->make('partials.layout._keyboard-shortcuts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>



<?php echo $__env->make('partials.layout._layout-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\laragon\www\iboa\resources\views/layouts/erp.blade.php ENDPATH**/ ?>