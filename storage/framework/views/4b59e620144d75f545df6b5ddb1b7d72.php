...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" style="display:flex; flex-direction:column; gap:20px;">
        <?php echo csrf_field(); ?>

        
        <div>
            <label for="email" class="g-label">Nom d'utilisateur</label>
            <div class="g-field <?php echo e($errors->has('email') ? 'has-error' : ''); ?>">
                <span class="g-icon">
        ...
        <div x-data="{ show: false }">
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:7px;">
                ...
                <a href="<?php echo e(route('password.request')); ?>" class="g-forgot">Oublié ?</a>
                <?php endif; ?>
            </div>
            <div class="g-field <?php echo e($errors->has('password') ? 'has-error' : ''); ?>">
                <span class="g-icon">
                    <svg width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\iboa\resources\views/auth/login.blade.php ENDPATH**/ ?>