<?php $__env->startSection('title', 'Journal comptable'); ?>
...
<div class="space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5"><?php echo e($entries->total()); ?> écriture(s)</p>
        </div>
        <div class="flex items-center gap-2 self-start">
            <a href="<?php echo e(route('comptabilite.journaux.export-pdf', request()->query())); ?>"
            ...
            <a href="<?php echo e(route('comptabilite.journaux.export', request()->query())); ?>"
    ...
    <form method="GET" class="bg-white rounded-xl border border-gray-200 p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            <input type="text" name="search" value="<?php echo e($filters['search'] ?? ''); ?>" placeholder="Numéro, libellé..."
            ...
            <select name="journal_type_id" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-violet-500">
                ...
                <?php $__currentLoopData = $journalTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($jt->id); ?>" <?php echo e(($filters['journal_type_id'] ?? '') == $jt->id ? 'selected' : ''); ?>>
                    <?php echo e($jt->code); ?> — <?php echo e($jt->name); ?>
            ...
            <select name="status" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-violet-500">
                ...
                <option value="valide"    <?php echo e(($filters['status'] ?? '') === 'valide'    ? 'selected' : ''); ?>>Validé</option>
                <option value="cloture"   <?php echo e(($filters['status'] ?? '') === 'cloture'   ? 'selected' : ''); ?>>Clôturé</option>
            </select>
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <table class="tbl tbl-sticky w-full">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td>
                            <a href="<?php echo e(route('comptabilite.journaux.show', $entry)); ?>"
                               class="font-mono font-semibold text-violet-600 hover:text-violet-800">
                                <?php echo e($entry->number); ?>

                            </a>
                        </td>
                        <td class="hidden md:table-cell">
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-700 font-mono">
                                <?php echo e($entry->journalType?->code); ?>

                            </span>
                        </td>
                        <td class="text-gray-600 hidden lg:table-cell"><?php echo e($entry->entry_date?->format('d/m/Y')); ?></td>
                        <td class="text-gray-700">
                            <?php echo e(\Illuminate\Support\Str::limit($entry->description, 50)); ?>

                            <?php if($entry->reference): ?>
                            <span class="text-xs text-gray-400 ml-1"><?php echo e($entry->reference); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="text-right tabular-nums text-gray-700 hidden lg:table-cell">
                            <?php echo e(number_format($entry->total_debit, 0, ',', ' ')); ?>

                        </td>
                        <td class="text-right tabular-nums hidden lg:table-cell">
                            <span class="<?php echo e($entry->total_debit !== $entry->total_credit ? 'text-red-600 font-semibold' : 'text-gray-700'); ?>">
                                <?php echo e(number_format($entry->total_credit, 0, ',', ' ')); ?>

                            </span>
                        </td>
                        <td class="text-center">
                            <?php $color = $entry->statusColor(); ?>
                        ...
                        <td>
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('accounting.validate')): ?>
                                <form action="<?php echo e(route('comptabilite.journaux.validate', $entry)); ?>" method="POST"
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(route('comptabilite.journaux.destroy', $entry)); ?>" method="POST"
        ...
        <div class="px-4 py-3 border-t border-gray-100">
            <?php echo e($entries->appends($filters)->links()); ?>
...
<?php echo $__env->make('layouts.erp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iboa\resources\views/comptabilite/journaux/index.blade.php ENDPATH**/ ?>